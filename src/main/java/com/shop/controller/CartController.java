...
public class CartController {
    ...
    @PostMapping("/cart")
    public ResponseEntity<?> order(@Valid @RequestBody  CartItemDto cartItemDto, BindingResult bindingResult, Authentication authentication) {
    ...
    @PatchMapping("/cartItem/{cartItemId}")//RequestParam: ?count=
