...
class MemberTest {
    ...
    @WithMockUser(username="gildong", roles="USER") //가짜 유저
    void auditingTest() {
        ...
        System.out.println("create member " + savedMember.getCreateBy() );
        System.out.println("modified member " + savedMember.getModifiedBy() );
